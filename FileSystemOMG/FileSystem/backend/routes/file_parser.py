"""
Маршруты для парсинга содержимого файлов
"""
...
def parse_file_content(current_user):
    """Парсит содержимое файла и возвращает HTML"""
    try:
        ...
        # Декодируем путь - путь уже должен быть относительным от base_path
        # Если путь начинается с internal/ или external/, убираем это
