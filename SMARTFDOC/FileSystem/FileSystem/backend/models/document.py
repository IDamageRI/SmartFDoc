...
class Document:
    ...
    def from_row(cls, row, table_name='internal_documents'):
        ...
        if table_name == 'internal_documents':
            ...
            doc.sender_inn = safe_get('sender_inn')
            doc.sender_kpp = safe_get('sender_kpp')
            doc.recipient_department_id = safe_get('recipient_department_id')
            doc.recipient_user_id = safe_get('recipient_user_id')
    ...
    def to_dict(self, include_relations=False):
        ...
        if hasattr(self, 'sender_inn'):
            data['sender_inn'] = self.sender_inn
        if hasattr(self, 'sender_kpp'):
            data['sender_kpp'] = self.sender_kpp
